...
from sklearn import neighbors, metrics, model_selection, ensemble
...
def run_forecast(target, horizon):
    ...
    features = [
        ['ET', ensemble.ExtraTreesRegressor(n_estimators=85,max_depth=7)],
    ]
    ...
    for Xtra, Xtes, f in zip([train_X_endo, train_X], [test_X_endo, test_X], ['endo', 'exo']):
        ...
        for feature in features:
            ...
            for name, model in models:
                ...
                # train_rms = metrics.mean_squared_error(train_y, train_pred)
                # print(train_rms)
